                ...
                %>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input class="active" type="button" class="greenbutton" name="active" onclick="location.href='updateactive?uid=<%=u.getUserid()%>'" value="Active" style= "background: #f31404;color: #fff;font-size: 15px; height: 30px"/>
                        </td>
                        <td>
                            
                            <input class="unactive" type="button" class="greenbutton" name="unactive" onclick="location.href='updateunactive?uid=<%=u.getUserid()%>'" value="UnActive" style= "background: #f31404;color: #fff;font-size: 15px; height: 30px"/>
                        </td>
                    </tr>
